...
/**
 * Gateway proxy for the web app's authenticated client calls.
 *
 * The browser's client axios points at same-origin `/gateway/*`; requests land
 * here and are forwarded to NestJS with a server-side `Bearer` header (from the
