    ...
    <div className="min-h-screen bg-surface">
      <div className="bg-gradient-to-br from-body to-heading text-inverted py-12">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-3xl font-bold mb-2">Platform Hizmet Bedeli</h1>
          <p className="text-subtle">Son güncelleme: 2 Haziran 2026</p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-surface-elevated rounded-2xl shadow-sm p-8 prose prose-gray max-w-none">
          <h2>1. Nedir?</h2>
          <p>
            Platform Hizmet Bedeli, TARODAN üzerinden yaptığınız her satın almada
            ürün bedelinin <strong>%3'ü oranında</strong> alınan bir hizmet
            ücretidir. Bu bedel, ödeme altyapısı, güvenli alışveriş garantisi,
            uyuşmazlık çözümü ve platform üzerinde sunduğumuz diğer hizmetler
            için kullanılır.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>KDV:</strong> Tutara KDV dahildir; ayrıca KDV
              eklenmez.
            </li>
          </ul>
