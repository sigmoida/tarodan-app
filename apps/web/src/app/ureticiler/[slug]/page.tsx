    ...
    if (!brand) {
        return (
            <div className="min-h-screen bg-[#F8F9FA] flex flex-col items-center justify-center p-4 text-center">
                ...
                <h2 className="text-3xl font-bold text-gray-900 mb-2">Üretici Bulunamadı</h2>
                <Link href="/ureticiler" className="mt-8 px-8 py-3 bg-gray-900 text-white rounded-full font-bold hover:bg-primary-600 transition-all shadow-lg hover:shadow-primary-500/25">
                    Tüm Üreticilere Dön
                </Link>
            </div>
        );
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] pb-24 pt-8">
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <Link href="/ureticiler" className="inline-flex items-center gap-2 text-gray-400 hover:text-primary-600 font-medium mb-8 transition-colors group">
