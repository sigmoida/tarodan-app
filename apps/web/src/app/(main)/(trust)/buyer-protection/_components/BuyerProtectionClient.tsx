			...
			<SectionCard>
				<div className='prose prose-gray max-w-none'>
					...
					<p>
						...
						alışverişlerde ürünün tanıma uygun gelmemesi, hiç gönderilmemesi veya
						ciddi anlaşmazlık durumlarında inceleme ve gerekirse para iadesi
						süreçlerini kapsar. Bu sayfa, haklarınızı ve başvuru sürecini özetler.
					</p>
					...
					<p>
						...
						<Link href='/refund-policy' className='text-primary-500 hover:underline'>
							İade Politikası
						</Link>{' '}
						ve{' '}
						<Link
					...
					<p>
						...
						iade edilebilir veya anlaşmazlık çözümüne göre alıcı lehine para
						iadesi yapılabilir. "Para iade garantisi" ifadesi, platformun
