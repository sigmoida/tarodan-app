		...
		<DocPage
				...
				<div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-4'>
					{STEPS[lang].map((step, i) => (
						<div
							...
							<h3 className='mb-1.5 font-semibold text-heading'>{step.title}</h3>
				...
				<div className='grid gap-4 sm:grid-cols-2'>
					{GUARANTEES[lang].map((item, i) => (
						<div
							...
							<div>
								<h3 className='mb-1 font-semibold text-heading'>{item.title}</h3>
			...
			<SectionCard
				...
				<div className='flex flex-col gap-3 sm:flex-row'>
					<Link
						href={
							isAuthenticated ? '/profile/trades' : '/login?redirect=/profile/trades'
						}
