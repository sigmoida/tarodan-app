...
const PERKS = ['Detaylı satış tahminleri', 'Rakip analizi', 'PDF/Excel rapor indirme'];
				...
				<div className='flex items-start gap-4'>
					...
					<div>
						...
						<p className='max-w-md text-primary-100'>
							Daha detaylı analizler, gelişmiş grafikler ve kişiselleştirilmiş öneriler için
