...
const ROWS: { key: keyof NotificationSettings; title: string; desc: string }[] = [
	...
	{ key: 'pushNotifications', title: 'Anlık Bildirimler', desc: 'Tarayıcı bildirimleri al' },
	{ key: 'orderUpdates', title: 'Sipariş Güncellemeleri', desc: 'Sipariş durumu değişikliklerinde bildirim al' },
	{ key: 'messageAlerts', title: 'Mesaj Uyarıları', desc: 'Yeni mesaj geldiğinde bildirim al' },
	{ key: 'priceDropAlerts', title: 'Fiyat Düşüşü Uyarıları', desc: 'Favori ürünlerde fiyat düşünce haber ver' },
	{ key: 'marketingEmails', title: 'Pazarlama E-postaları', desc: 'Kampanya ve fırsatlardan haberdar ol' },
];
