                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm">
                              <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                                {isGroup ? (
                                  ...
                                  <Link href={`/profile/orders/${payment.orderId}`} className="text-primary-600 hover:text-primary-700">
                                    {t('common.details')}
                                  </Link>
                                ) : null}
                                  ...
                                  {groupOrders.map((o) => (
                                    <div key={o.id} className="flex items-center gap-3 rounded-lg border border-border-subtle bg-surface-elevated p-2">
                                      ...
                                      <div className="flex-1 min-w-0">
                                        <Link href={`/profile/orders/${o.id}`} className="block truncate text-sm font-medium text-heading hover:text-primary-600">
                                          {o.title}
                                        </Link>
                                        <p className="text-xs text-muted">
                                      ...
                                      <Link href={`/profile/orders/${o.id}`} className="whitespace-nowrap text-sm text-primary-600 hover:underline">
                                        {t('common.details')}
                                      </Link>
                                    </div>
                                  ))}
