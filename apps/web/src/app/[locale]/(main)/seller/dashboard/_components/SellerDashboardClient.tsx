...
export default function SellerDashboardClient() {
  ...
  const { totalRevenue, activeCount, soldCount, pendingCount, isLoading } =
    useSellerDashboard();
    ...
    <PageShell>
      <div className="mx-auto w-full max-w-5xl space-y-8">
        <PageHeader
          ...
          description={t("sellerDashboard.subtitle")}
        />
                    ...
                    <div>
                      <p className="font-semibold text-heading">
                        {pendingCount === 0
                          ...
                          : t("sellerDashboard.pendingOrdersCount", {
                              count: pendingCount,
                            })}
                      </p>
