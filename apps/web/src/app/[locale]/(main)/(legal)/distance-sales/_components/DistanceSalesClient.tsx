    ...
    >
      <SectionCard>
        <div className="prose prose-gray max-w-none">
          ...
          <h3>1.2 ALICI</h3>
          <p>
            İşbu sözleşmeyi onaylayan ve TARODAN platformu üzerinden alışveriş
            yapan gerçek veya tüzel kişi ("Alıcı").
          </p>
          <p className="text-sm text-muted">
            Not: Alıcı bilgileri, sipariş onayı sırasında girilen bilgilerden
            oluşur.
          </p>
          ...
          <p>
            ...
            Mesafeli Sözleşmeler Yönetmeliği hükümleri gereğince tarafların hak
            ve yükümlülüklerini kapsar.
          </p>
          ...
          <ul>
            ...
            <li>Sanal Kart</li>
            <li>
              Ödeme işlemleri PayTR altyapısı ile güvenli şekilde
              gerçekleştirilir
            </li>
          </ul>
          ...
          <p>
            4.1. ALICI, SATICI'ya ait internet sitesinde sözleşme konusu ürünün
          ...
          <p>
            4.2. ALICI'nın; Ön Bilgilendirme Formunu elektronik ortamda teyit
            ...
            ürünlere ait temel özellikleri, ürünlerin vergiler dâhil fiyatını,
            ödeme ve teslimat bilgilerini de doğru ve eksiksiz olarak edindiğini
            kabul, beyan ve taahhüt eder.
          </p>
          <p>
            4.3. Sözleşme konusu her bir ürün, 30 günlük yasal süreyi aşmamak
          ...
          <p>
            4.4. SATICI, Sözleşme konusu ürünü eksiksiz, siparişte belirtilen
            niteliklere uygun ve varsa garanti belgeleri, kullanım kılavuzları
            ile birlikte teslim etmeyi, her türlü ayıptan arî olarak yasal
            mevzuat gereklerine göre sağlam, standartlara uygun bir şekilde işin
            gereği olan bilgi ve belgeler ile işi doğruluk ve dürüstlük esasları
          ...
          <p>
            5.1. ALICI; mal satışına ilişkin mesafeli sözleşmelerde, ürünün
            kendisine veya gösterdiği adresteki kişi/kuruluşa teslim tarihinden
            itibaren 14 (on dört) gün içerisinde, SATICI'ya bildirmek şartıyla,
          ...
          <p>5.3. Cayma hakkının kullanılması halinde:</p>
          <ul>
            <li>
              ALICI'ya veya ALICI'nın belirlediği üçüncü kişiye teslim edilen
              ürünün faturası (İade edilecek ürünün faturası kurumsal ise, iade
              faturası kesilmesi gerekmektedir)
            </li>
            <li>İade formu</li>
            <li>
          ...
          <p>
            5.4. SATICI, cayma bildiriminin kendisine ulaşmasından itibaren en
            geç 14 gün içinde toplam bedeli ALICI'ya iade etmekle yükümlüdür.
            ALICI'nın kredi kartı ile yaptığı alışverişlerde iade, ALICI kredi
            kartına yapılır.
          </p>
          <p>
            5.5. Cayma hakkının kullanılması nedeniyle SATICI tarafından
          ...
          <ul>
            <li>
              ...
              ve satıcının kontrolünde olmayan mal veya hizmetlere ilişkin
              sözleşmeler
            </li>
            <li>
            ...
            <li>
              Belirli bir tarihte veya dönemde yapılması gereken, konaklama,
          ...
          <p>
            6.2. Sözleşme konusu ürün, yasal 30 günlük süreyi aşmamak koşulu ile
            her bir ürün için ALICI'nın yerleşim yerinin uzaklığına bağlı olarak
            ön bilgiler içinde açıklanan süre içinde ALICI veya gösterdiği
          ...
          <p>
            8 (sekiz) maddeden ibaret bu sözleşme, taraflarca okunarak, [SİPARİŞ
            TARİHİ] tarihinde, ALICI tarafından elektronik ortamda onaylanmak
            suretiyle akdedilmiş ve yürürlüğe girmiştir.
          </p>

          <div className="mt-8 p-4 bg-surface-alt rounded-lg">
            <p className="text-sm text-muted">
              Bu sözleşme, sipariş onayı sırasında elektronik ortamda
              onaylandığında yürürlüğe girer. Sözleşmenin bir kopyası sipariş
              onayı e-postası ile gönderilir.
            </p>
          </div>
        </div>
      </SectionCard>
