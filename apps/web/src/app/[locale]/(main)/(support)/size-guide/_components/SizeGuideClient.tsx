...
export default function SizeGuideClient() {
  ...
  const scales = [
    {
      scale: t("information.sizeGuide.scale18"),
      length: "~25–30 cm",
      note: t("information.sizeGuide.note18"),
    },
    {
      scale: t("information.sizeGuide.scale24"),
      length: "~18–20 cm",
      note: t("information.sizeGuide.note24"),
    },
    {
      scale: t("information.sizeGuide.scale43"),
      length: "~10–12 cm",
      note: t("information.sizeGuide.note43"),
    },
    {
      scale: t("information.sizeGuide.scale64"),
      length: "~6–8 cm",
      note: t("information.sizeGuide.note64"),
    },
  ];
