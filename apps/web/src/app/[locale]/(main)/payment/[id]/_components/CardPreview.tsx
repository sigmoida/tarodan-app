...
// Skeuomorphic credit-card preview: the raw `text-white/*` colors and fixed
// `text-[9px]/[10px]` micro-labels here intentionally mimic a physical card and
// are an accepted exception to the design-token rules (§2). They must not be
// swapped for semantic tokens or the `text-2xs` scale — the card look depends on
// these exact values.
import {
  BRAND_GRADIENT,
  formatCardNumber,
...
export default function CardPreview({
  ...
  return (
    <div
      className="relative mx-auto aspect-[1.586/1] w-full max-w-sm sm:mx-0"
      ...
      >
        ...
        >
          ...
          <div className="mt-4 px-5">
            <div className="mb-1 text-right text-[9px] uppercase tracking-widest text-white/60">
              CVV
            </div>
