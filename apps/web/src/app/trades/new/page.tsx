    ...
    return (
      <div className="min-h-screen bg-surface py-8">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-muted mb-4">{t('trade.targetNotFound')}</p>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-6 mb-6">
          ...
          <div className="bg-surface-elevated rounded-xl p-6 shadow-sm border border-border flex-1">
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="relative w-full aspect-square max-w-[200px] rounded-lg overflow-hidden bg-surface-alt">
                <OptimizedImage
              ...
              <div className="text-center w-full">
                <h3 className="font-medium text-heading line-clamp-2 mb-2">
                  {targetProduct.title}
                </h3>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-4">
                  <Radio
                    ...
                    label={locale === 'en' ? 'I will pay' : 'Ben ödeyeceğim'}
                  />
                  <Radio
                    name="cashPayer"
                    value="them"
                    ...
                    onChange={(e) => setCashPayer(e.target.value as 'me' | 'them')}
                    label={locale === 'en' ? 'They will pay' : 'Karşı taraf ödeyecek'}
                  />
                </div>
              </div>
            )}
          ...
          <div className="space-y-2 text-body">
            ...
            <div className="border-t border-primary-200 pt-2 mt-2">
              <div className="flex justify-between text-lg font-bold">
                ...
                <span className="text-primary-600">{calculateTotal().toLocaleString('tr-TR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} TL</span>
              </div>
            </div>
        ...
        <div className="flex gap-4">
          <Button variant="secondary" onClick={() => router.back()}
            className="flex-1 px-6 py-4 text-body rounded-xl font-semibold hover:bg-surface">
            {t('common.cancel')}
          </Button>
          <Button variant="secondary" onClick={handleSubmit}
            disabled={isSubmitting || (selectedProducts.length === 0 && !cashAmount)}
            className="flex-1 px-6 py-4 bg-primary-500 hover:bg-primary-600 text-inverted rounded-xl font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
            {isSubmitting ? (
              <>
