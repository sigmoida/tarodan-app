      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="flex gap-4">
          <Button variant="secondary" onClick={() => router.back()}
            className="flex-1 px-6 py-4 text-gray-700 rounded-xl font-semibold hover:bg-gray-50">
            {t('common.cancel')}
          </Button>
          <Button variant="secondary" onClick={handleSubmit}
            disabled={isSubmitting || (selectedProducts.length === 0 && !cashAmount)}
            className="flex-1 px-6 py-4 bg-primary-500 hover:bg-primary-600 text-white rounded-xl font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
            {isSubmitting ? (
              <>
