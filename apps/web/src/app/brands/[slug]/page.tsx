    ...
    if (!brand) {
        return (
            <div className="min-h-screen bg-[#F8F9FA] flex flex-col items-center justify-center p-4 text-center">
                ...
                <Link href="/brands" className="mt-8 px-8 py-3 bg-gray-900 text-white rounded-full font-bold hover:bg-primary-600 transition-all shadow-lg hover:shadow-primary-500/25">
                    Tüm Markalara Dön
                </Link>
            </div>
        );
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] pb-24 pt-8">
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <Link href="/brands" className="inline-flex items-center gap-2 text-gray-400 hover:text-primary-600 font-medium mb-8 transition-colors group">
                ...
                >
                    <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-bl from-primary-50 via-white to-transparent rounded-full -translate-y-1/2 translate-x-1/2 opacity-60 pointer-events-none" />
                            ...
                            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                                {brand.website && (
                                    <a
                                        ...
                                        className="inline-flex items-center gap-2 px-6 py-3 bg-white border border-gray-200 rounded-full text-gray-700 font-bold hover:bg-gray-50 hover:text-primary-600 transition-colors shadow-sm"
                                    >
                ...
                {models.length > 0 && (
                    <div className="mb-12">
                        <div className="flex items-center justify-between mb-6 px-2">
                            ...
                            {selectedModelId && (
                                <Button variant="secondary" onClick={() => setSelectedModelId(null)}
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            {models.map((model) => (
                                <Button variant="secondary" key={model.id}
                ...
                <div>
                    ...
                    {productsQuery.isLoading ? (
                        ...
                        >
                            ...
                            <Link href="/listings/new" className="inline-block px-10 py-4 bg-gray-900 text-white rounded-full font-bold shadow-xl shadow-gray-900/10 hover:bg-primary-600 hover:shadow-primary-500/30 transition-all transform hover:-translate-y-1">
                                    ...
                                    return (
                                        <motion.div key={product.id} variants={itemVariants} layout>
                                            <Link
                                                ...
                                                className="group block bg-white rounded-[1.5rem] p-3 h-full border border-gray-100 hover:border-primary-100/50 hover:shadow-2xl hover:shadow-gray-200/50 transition-all duration-500 relative overflow-hidden"
                                            >
                                                {/* Image Area */}
                                                <div className="aspect-[4/3] relative bg-gray-50 rounded-[1.2rem] overflow-hidden mb-4">
                                                    ...
                                                    <div className="absolute top-3 left-3 flex flex-col gap-2 z-10">
                                                        {product.isPreorder && (
                                                            <span className="bg-white/90 backdrop-blur text-warning-600 text-[10px] font-black uppercase px-2 py-1 rounded-md shadow-sm border border-warning-100">ÖN SİPARİŞ</span>
                                                        )}
                                                        {product.isLimited && (
                                                        ...
                                                        {product.status === 'sold' && (
                                                            <span className="bg-danger-500 text-white text-[10px] font-black uppercase px-2 py-1 rounded-md shadow-sm">SATILDI</span>
                                                        )}
                                                    </div>

                                                    {isSale && product.discountPercent && (
                                                        <div className="absolute top-3 right-3 bg-danger-500 text-white text-xs font-black px-2 py-1 rounded-md shadow-sm z-10">
                                                ...
                                                <div className="px-2 pb-2">
                                                    ...
                                                    <h3 className="font-bold text-gray-900 text-sm mb-3 line-clamp-2 leading-snug group-hover:text-primary-600 transition-colors h-10">
                                                        {product.title}
                                                    </h3>
                                                    ...
                                                    <div className="flex items-center justify-between border-t border-gray-50 pt-3">
                                                        <div className="flex flex-col">
                                                            {isSale ? (
                                                                <>
                                                                    <span className="text-xs text-gray-400 line-through decoration-danger-400">₺{originalPrice.toLocaleString('tr-TR')}</span>
