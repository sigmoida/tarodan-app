        ...
        >
          ...
          <div className="mb-6">
            <motion.div
              ...
              className="w-20 h-20 bg-danger-100 rounded-full flex items-center justify-center mx-auto"
            >
          ...
          <div className="bg-info-50 border border-info-200 rounded-lg p-4 mb-6 text-left">
            <p className="text-sm text-info-800">
              <strong>
                {locale === "en" ? "Need help?" : "Yardıma mı ihtiyacınız var?"}
              </strong>{" "}
              {locale === "en"
                ? "If your payment issue persists, please contact "
                : "Ödeme sorununuz devam ederse, lütfen "}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {isGuestCheckout ? (
              ...
              <>
                <Button onClick={handleRetryPayment} className="flex gap-2">
