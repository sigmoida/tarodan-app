...
export type ProductStatus =
  "pending" | "active" | "reserved" | "sold" | "inactive" | "rejected";
...
/**
 * Platform settings. Shipping fee/threshold are NOT here — they come from the active
 * shipping tariff via the server (cart calculation / checkout quote), never hardcoded.
 */
