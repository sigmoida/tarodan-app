              ...
              {showAuthUI && (
                ...
                >
                  ...
                  {unreadMessageCount > 0 && (
                    <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 flex items-center justify-center bg-danger-500 text-white text-[10px] font-semibold rounded-full">
