...
import LanguageSwitcher from '@/components/LanguageSwitcher';import { Button } from '@tarodan/ui';
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.instagram.com/tarodan.com.tr/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-surface-alt hover:bg-primary-50 hover:text-primary-500 text-muted transition-colors" style={{borderRadius:'4px'}} aria-label="Instagram">
