...
export default function CookieConsentBanner() {
  ...
  const saveConsent = (prefs: CookiePreferences) => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify(prefsWithTimestamp),
    );
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted dark:text-border-strong text-sm leading-relaxed mb-4">
                      Sitemizde deneyiminizi geliştirmek, trafiği analiz etmek
                      ve size kişiselleştirilmiş içerik sunmak için çerezler
            ...
            {showSettings && (
              ...
              >
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-center justify-between p-4 bg-surface dark:bg-heading/50 rounded-xl">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="font-medium text-heading dark:text-inverted">
                          Zorunlu Çerezler
                        </span>
                      ...
                      <p className="text-sm text-muted dark:text-subtle">
                        Web sitesinin temel işlevleri için gereklidir. Güvenlik,
                        ağ yönetimi ve erişilebilirlik gibi temel özellikleri
                        sağlar. Bu çerezler olmadan site düzgün çalışmaz.
                      </p>
                    </div>
                    <div className="ml-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-surface dark:bg-heading/50 rounded-xl">
                    <div className="flex-1">
                      <div className="font-medium text-heading dark:text-inverted mb-1">
                        Analitik Çerezler
                      </div>
                      <p className="text-sm text-muted dark:text-subtle">
                        Ziyaretçilerimizin sitemizi nasıl kullandığını
                        anlamamıza yardımcı olur. Sayfa görüntülemeleri, trafik
                        kaynakları ve kullanıcı davranışları gibi istatistiksel
                        verileri toplar.
                      </p>
                    </div>
                    <div className="ml-4">
                      <Button
                        ...
                        className={`w-12 h-7 rounded-full flex items-center px-1 transition-colors ${
                          preferences.analytics
                            ? "bg-primary-500"
                            : "bg-border-strong dark:bg-body"
                        }`}
                      >
                        <div
                          className={`w-5 h-5 bg-surface-elevated rounded-full shadow transition-transform ${
                  ...
                  <div className="flex items-center justify-between p-4 bg-surface dark:bg-heading/50 rounded-xl">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted dark:text-subtle">
                        Size kişiselleştirilmiş reklamlar ve içerikler sunmak
                        için kullanılır. İlgi alanlarınıza göre hedeflenmiş
                        pazarlama kampanyaları için verilerinizi reklam
                        ortaklarıyla paylaşabilir.
                      </p>
                    </div>
                    <div className="ml-4">
                      <Button
