...
export class TradeService {
  ...
  private async cancelSuratShipmentsForTrade(tradeId: string): Promise<void> {
    return this.tradeShipment.cancelSuratShipmentsForTrade(tradeId);
  }
  ...
  // private delege; kalan reconciliation metodları kullanıyor). Yanıt
  // formatlama yardımcıları (mapToResponseDto, mapTradeItemToDto,
  // resolveProductImageUrl, computeCanCancel) da trade-common'da;
  // facade'de kullanıcı kalmadığı için delege yok.
