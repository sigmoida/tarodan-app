...
export class CartCalculationResponseDto {
  ...
  @ApiProperty({ description: 'Ürün bazlı indirimler toplamı (strike-through)' })
  ...
  @ApiProperty({ description: 'Grand total (subtotal - totalDiscount + shipping)' })
  grandTotal: number;

  @ApiPropertyOptional({ description: 'Uygulanan kupon kodu' })
  appliedCouponCode?: string;

  @ApiProperty({ type: [AppliedDiscountDto], description: 'Uygulanan indirimler' })
