...
export class CreateNotificationTemplateDto {
  ...
  @ApiProperty({
    description: "Notification title with {{variables}}",
    example: "Your order {{orderNumber}} has shipped!",
  })
  @IsString()
  @MaxLength(200)
  title: string;
  ...
  @ApiProperty({
    description: "Notification body with {{variables}}",
    example: "Track your order at {{trackingUrl}}",
  })
  @IsString()
  body: string;
  ...
  @ApiPropertyOptional({
    description: "Variable names for documentation",
    example: ["orderNumber", "trackingUrl"],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
...
export class SendNotificationDto {
  ...
  @ApiPropertyOptional({
    description: "User IDs (when targetType is user_ids)",
  })
  @IsOptional()
  @IsArray()
  @IsUUID("4", { each: true })
  ...
  @ApiPropertyOptional({
    description: "Segment filter criteria (when targetType is segment)",
  })
  @IsOptional()
  segmentCriteria?: {
    isSeller?: boolean;
...
export class NotificationHistoryQueryDto extends AdminListQueryDto {
  ...
  @ApiPropertyOptional({ description: "Search title, body, or recipient" })
  @IsOptional()
  @IsString()
  search?: string;
