...
export class ProductQueryDto {
  @ApiPropertyOptional({
    example: "star wars",
    description:
      "Full-text search query (primary: Elasticsearch, fallback: Postgres title/description)",
  })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({
    example: "1:64",
    description:
      "Filter by scale (matched via ProductAttribute join, not text search)",
  })
  @IsOptional()
  @IsString()
  scale?: string;
  ...
  @ApiPropertyOptional({
    example: "diecast",
    description:
      "Filter by material (attribute slug: diecast, resin, composite, plastic)",
  })
  @IsOptional()
  @IsString()
  material?: string;
  ...
  @ApiPropertyOptional({
    example:
      '{"hw-rarity":["treasure-hunt","super-treasure-hunt"],"hw-body-color":["red"]}',
    description:
  ...
  @ApiPropertyOptional({
    example: "Hot Wheels",
    description:
      "Filter by manufacturer name (exact match on relation, prefer manufacturerId)",
  })
  @IsOptional()
  @IsString()
  manufacturer?: string;
