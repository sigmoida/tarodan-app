...
import type { SuratShipmentFailure } from './surat-cargo.types';

const USER_TECHNICAL_TR =
  'Kargo sistemine şu an ulaşılamıyor. Lütfen bir süre sonra tekrar deneyin.';
const USER_BUSINESS_TR = 'Gönderi oluşturulamadı. Bilgilerinizi kontrol edip tekrar deneyin.';

/**
 * Maps a failed Surat result to HTTP exceptions. Logs should include full technical/business detail.
 */
export function mapSuratFailureToHttpException(result: SuratShipmentFailure): never {
