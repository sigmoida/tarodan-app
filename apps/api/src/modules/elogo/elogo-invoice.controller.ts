...
export class ElogoInvoiceController {
  ...
  @ApiOperation({
    summary: 'Bir siparişe ait kullanıcının e-Arşiv faturası (yoksa null) — "Faturayı İndir" butonu için',
  })
  async byOrder(
  ...
  @Get(':id/pdf')
  @ApiOperation({ summary: 'e-Arşiv fatura PDF (S3 presigned redirect veya canlı stream)' })
