...
@Module({
  imports: [ScheduleModule.forRoot(), PrismaModule, ConfigModule, CacheModule, EventModule, NotificationModule, StorageModule, OrderModule, ProductModule, BullModule.registerQueue({ name: QUEUE_NAMES.SCHEDULED })],
