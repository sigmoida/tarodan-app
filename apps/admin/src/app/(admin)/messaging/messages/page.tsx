...
export default function MessagesPage() {
  return (
    <AdminPage>
      <PageHeader title="Mesaj Moderasyonu" description={<MessagesSummary />} />
        ...
        fetcher={(params) => {
          ...
          return adminApi
            ...
            .then((res) => {
              ...
              return { ...res, data: { data: raw.map(mapMessage), meta: { total } } };
            });
        }}
        getRowId={(m) => m.id}
        syncUrl
      ...
      >
        <ResourceList.Toolbar>
          <ResourceList.Search placeholder="Mesaj içeriği, gönderen/alıcı ara..." />
