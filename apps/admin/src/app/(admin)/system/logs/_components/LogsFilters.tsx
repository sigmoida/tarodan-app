...
export function LogsFilters({
  ...
  const sel = (name: string, options: { value: string; label: string }[], fallback: string, className: string) => (
    <Select
  ...
  if (tab === 'errors') return sel('severity', OPTIONS.errorSeverity, 'all', 'sm:w-48');
  if (tab === 'security')
    return (
      <>
