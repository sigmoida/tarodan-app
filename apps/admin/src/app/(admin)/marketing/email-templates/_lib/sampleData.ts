...
export const sampleData = (t: T): Record<string, Record<string, unknown>> => ({
  ...
  "email-verification": {
    name: t("admin.marketing.emailTemplates.sample.user"),
    verificationUrl: "https://tarodan.com/verify?token=sample",
  ...
  "product-approved": {
    sellerName: t("admin.marketing.emailTemplates.sample.seller"),
    productTitle: "Hot Wheels Ferrari 458",
    productUrl: "https://tarodan.com/products/sample",
  },
    ...
    trendingProducts: [
      {
        ...
        price: 199,
        productUrl: "https://tarodan.com/products/1",
      },
    ],
  },
  "marketing-monthly": {
    ...
    featuredProducts: [
      {
        ...
        price: 149,
        productUrl: "https://tarodan.com/products/2",
      },
    ],
  },
  // Seller application
  ...
  "trade-received": {
    ...
    tradeUrl: "https://tarodan.com/trades/sample-trade",
  },
  "trade-accepted": {
    name: t("admin.marketing.emailTemplates.sample.userShort"),
    tradeUrl: "https://tarodan.com/trades/sample-trade",
  ...
  "refund-return-label-buyer": {
    ...
    returnUrl: "https://tarodan.com/orders/sample-id/return",
  },
  // Review
  "review-received-seller": {
    ...
    reviewUrl: "https://tarodan.com/seller/reviews",
  },
  // Listing & stock
  "listing-expiring": {
    sellerName: t("admin.marketing.emailTemplates.sample.seller"),
    ...
    daysRemaining: 3,
    expirationDate: "2024-12-31",
    listingUrl: "https://tarodan.com/seller/listings",
  },
  "listing-expired": {
    sellerName: t("admin.marketing.emailTemplates.sample.seller"),
    productTitle: "Hot Wheels Ferrari 458",
  ...
  "new-follower": {
    ...
    followerUrl: "https://tarodan.com/profile/followers",
  },
  // Payout
