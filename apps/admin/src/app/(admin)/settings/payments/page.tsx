  ...
  const loadSettings = async () => {
    try {
      ...
      if (Array.isArray(settingsData)) {
        const item = settingsData.find(
          (s: any) =>
            s.settingKey === "payment_gateways" || s.key === "payment_gateways",
        );
      ...
      if (gatewaysSetting) {
        try {
          ...
          const parsed =
            typeof gatewaysSetting === "string"
              ? JSON.parse(gatewaysSetting)
              : gatewaysSetting;
              ...
              <div className="flex items-center gap-2">
                <label className="relative inline-flex items-center cursor-pointer">
                  <Checkbox
                    ...
                    onChange={(e) =>
                      updateGateway(gateway.id, { enabled: e.target.checked })
                    }
                ...
                <div key={key}>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) =>
                        updateConfig(gateway.id, key, e.target.value)
                      }
                      className="pl-10"
