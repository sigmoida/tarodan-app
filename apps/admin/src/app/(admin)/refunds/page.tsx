...
export default function RefundsPage() {
    ...
    const loadRefunds = async () => {
        setLoading(true);
        try {
            const res = await adminApi.getRefundHistory({ search: search || undefined, startDate: startDate || undefined, endDate: endDate || undefined, page, limit: 20 });
            setRefunds(res.data.data || []);
            setTotal(res.data.meta?.total || 0);
        } catch (e: any) { toast.error('İade geçmişi yüklenemedi'); }
        ...
        <>
            <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <button onClick={handleSearch} className="btn-primary">Filtrele</button>
                </div>
