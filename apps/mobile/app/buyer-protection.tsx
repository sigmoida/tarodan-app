...
const styles = StyleSheet.create({
  ...
  heroTitle: { fontSize: 22, fontWeight: 'bold', color: colors.white, marginTop: theme.spacing[3] },
  heroDate: { fontSize: 13, color: colors.gray[400], marginTop: theme.spacing[1.5] },
  content: { padding: theme.spacing[4] },
  card: { marginBottom: theme.spacing[3], backgroundColor: colors.surface.DEFAULT },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: theme.spacing[2.5], gap: theme.spacing[2] },
