...
const styles = StyleSheet.create({
  ...
  sellerStats: { flexDirection: 'row', gap: 12, marginTop: 4 },
  sellerStat: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  sellerStatText: { fontSize: 13, color: colors.text.muted },
  sellerResponseTime: { fontSize: 12, color: colors.text.muted, marginTop: 4 },
  sellerAction: { flexDirection: 'row', alignItems: 'center', gap: 8 },
