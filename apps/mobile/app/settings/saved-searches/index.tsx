  ...
  if (!f.isAuthenticated) {
    return (
      <View style={styles.centeredContainer}>
        ...
        <Text variant="body" style={styles.subtitle}>Aramalarınızı kaydetmek için giriş yapın</Text>
      ...
      <ScreenHeader
        ...
        right={
          <Text style={styles.headerCount}>
            {f.searches.length}/{f.maxSavedSearches === -1 ? '∞' : f.maxSavedSearches}
          </Text>
        }
      />

      {/* Limit Info */}
      {f.maxSavedSearches !== -1 && f.searches.length >= f.maxSavedSearches - 1 && (
